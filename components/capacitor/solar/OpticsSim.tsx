    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            if (params.mode === 'bench') {
                ...
                // 3. Crystalline Lens
                // Base power + Accommodation
                // Eye length ~ 24mm. Max power ~ 60D.
                // We simplify: Fixed retina position, variable focal length based on accommodation
                ...
                // Accommodation adds power (reduces focal length)
