...
// Helper functions for rendering solar system elements
// Updated to support new scaling logic if needed, but primarily kept for reference or specific draw calls.
