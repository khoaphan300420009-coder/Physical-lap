...
const AIChatView: React.FC = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            console.error(error);
            const errorMsg = 'Xin lỗi, tôi gặp sự cố khi kết nối tới máy chủ AI. Vui lòng kiểm tra lại cấu hình hệ thống.';
            ...
            <div className="h-20 border-b border-white/5 flex items-center justify-between px-8 bg-[#0a0a0f]/60 backdrop-blur-xl z-20 sticky top-0">
                <div className="flex items-center gap-4 font-display font-bold text-white tracking-wide">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] uppercase tracking-[0.2em] text-cyan-500/80 font-bold font-sans block">Powered by Gemini</span>
                    </div>
                </div>
